...
targets=irdstream.Stream2D("targets",datadir/"star",anadir,"IRDA0000")
targets.fitsid=list(range(3126,3186,2))+list(range(3194,3200,2))
flat_mmf1=irdstream.Stream2D("flat_mmf1",datadir/"flat"/"mmf1",anadir,"IRDA0000")
flat_mmf1.fitsid=list(range(3502,3562,2))
flat_mmf2=irdstream.Stream2D("flat_mmf2",datadir/"flat"/"mmf2",anadir,"IRDA0000")
