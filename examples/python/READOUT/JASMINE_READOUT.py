...
# target.fitsid=[47103]
target.fitsid = list(range(47076,47084,2))+list(range(47102,47106,2))+list(range(47270,47280,2))+list(range(47298,47302,2))
...
for datapath in target.rawpath:
    ...
    model_array.append(model_im)    
    
    #plot
    #corrected_detector(im, model_im, corrected_im)
np.savez("readout_pattern.npz",model_array)
