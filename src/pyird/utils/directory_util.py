...
def cp(anadir,fitsset,iraftag="ap"):
    ...
    fitsset_path_ap=fitsset.fitsdir/"database"/(iraftag+fitsset.tag+fitsset.extension)
    current_fitsset_path=anadir/(fitsset.tag+fitsset.extension+".fits")
    current_fitsset_path_ap=anadir/"database"/(iraftag+fitsset.tag+fitsset.extension)
